	...
	<div class="container">
		<table>
			...
			<tr>
				...
				<td class="bod" colspan="9"><b><jsp:getProperty name="binv" property="pnm" /></b></td> 
				<td rowspan="2" class="cen">No.</td>
				<td rowspan="2" class="cen"><jsp:getProperty name="binv" property="bno" /></td>
				
			</tr>
			<tr>
				<td class="bod"  colspan="10"  style="padding-top:10px;padding-bottom:10px;"><jsp:getProperty name="binv" property="padd"/><span style="float:right;"> MO : +91 93736 01875.</span>
					<br/>EMAIL : pentagon@pentagonmachines.com</td>
			</tr>
			<tr>
				<td colspan="10" class=""><b>GST NO : <jsp:getProperty name="binv" property="gno"/></b></td>
				<td style="text-align:center;">Date</td>
				<td style="text-align:center;"><jsp:getProperty name="binv" property="date" /> </td>
			</tr>
			<tr>
				<td colspan="12" class=""><b>STATE:- <jsp:getProperty name="binv" property="state" /> </b></td>
			</tr>
			...
			<tr>
				<td  class="bod">1</td>
				<td colspan="5"><jsp:getProperty name="binv" property="mnm" /> <br/><br/><br/><br/><br/><br/>
...
<b>A/C No:- </b>3870002100010437<br/><b>RTGS/NEFT IFS CODE –</b> PUNB0387000</pre>
				...
				<td colspan="2" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="qty" /></td>
				<td colspan="2" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="price" /> <br></td>
				<td colspan="2" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="price" /> <br></td>
			</tr>
			...
			<tr>
				...
				<td colspan="1"><jsp:getProperty name="binv" property="price" /></td>
			</tr>
			<tr>
				<td >RATE</td>
				<td >TAX</td>
				...
				<td colspan="1" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="cgst" /> </td>
			</tr>
			<tr>
				<td >9</td>
				<td ><jsp:getProperty name="binv" property="cgst" /> </td>
				<td >9</td>
				<td ><jsp:getProperty name="binv" property="sgst" /> </td>
				<td >18</td>
				<td ><jsp:getProperty name="binv" property="igst" /> </td>
				<td colspan="5"><b>ADD : SGST(9%)</b></td>
				<td colspan="1" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="sgst" /> </td>
			</tr>
			<tr>
				<td ></td>
				<td ></td>
				...
				<td colspan="1" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="igst" /> </td>
			</tr>
			<tr>
				
				<td class="bod" colspan=""></td>
				<td class="bod" colspan="10" style="text-align:right;padding-right:60px;"><b>TAX AMOUNT : GST</b></td>
				<td class="bod" colspan="1" style="text-align:center;padding-left:10px;padding-right:10px"><jsp:getProperty name="binv" property="ttax" /></td>
			</tr>
			<tr>
				<td class="bod" colspan="6"><b>GSTIN s:-24ABTPU1038N1Z1</b></td>
				<td class="bod" colspan="5" style=""><b>TOTAL AMOUNT AFTER TAX</b></td>
				<td class="bod" colspan="1" style="text-align:center;padding-left:10px;padding-right:5px"><jsp:getProperty name="binv" property="netamount" /> </td>
			</tr>
			<tr>
				<td class="none" colspan="8"><b>Rs.(in Words) : </b>Fourty Four THOUSAND Eight HUNDRED Fourty ONLY.</td>
